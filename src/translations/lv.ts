...
export const lv: TranslationSchema = {
  ...
  homePage: {
    seoTitle: 'JustioPro – Profesionāli Juridiskie Pakalpojumi un Konsultācijas',
    seoDesc: 'Profesionāls juridiskais atbalsts Jūsu biznesa izaugsmei un jebkurai ikdienā risināmai situācijai. Līgumu sagatavošana, komerctiesības, nekustamais īpašums, parādu piedziņa un pārstāvība tiesā.',
    ...
    aboutP1: 'Mēs sniedzam juridiskos pakalpojumus gan fiziskajām, gan juridiskajām personām, palīdzot labāk orientēties dažādos tiesību jautājumos, sagatavot nepieciešamos līgumus, juridiskos dokumentus, prasības pieteikumus, sūdzības, iesniegumus, un risināt jebkuras juridiska rakstura situācijas.',
  ...
  practicesPage: {
    ...
    seoDesc: 'JustioPro specializācija un juridiskie pakalpojumi: Līgumu sagatavošana, Komerctiesības, Nekustamais īpašums, Mantojuma tiesības, Maksātnespēja, Parādu piedziņa, Pārstāvība tiesā.',
  ...
  faqPage: {
    ...
    seoDesc: 'Atbildes uz biežāk uzdotajiem jautājumiem par JustioPro juridisko pakalpojumu izmaksām, konfidencialitāti, sadarbības procesu un konsultācijām.',
    heading: 'Biežāk',
  ...
  contactPage: {
    seoTitle: 'Kontakti – Juridiskās Konsultācijas | JustioPro',
    seoDesc: 'Sazinieties ar JustioPro juridisko biroju. Tālrunis: +371 26841758, E-pasts: info@justiopro.lv. Juridiskās konsultācijas fiziskām un juridiskām personām klātienē vai attālināti.',
