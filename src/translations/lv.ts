...
export const lv: TranslationSchema = {
  ...
  homePage: {
    ...
    partnerDesc: 'Nepieciešamības gadījumā sadarbojamies ar zvērinātiem notāriem, maksātnespējas administratoriem, piesaistam zvērinātus tiesu izpildītājus, advokātus un vajadzības gadījumā arī privātdetektīvu.',
  ...
  policyModal: {
    ...
    lastUpdated: 'Pēdējo reizi atjaunots: 2026.gada augustā',
    savedToast: 'Izvēle veiksmīgi saglabāta!',
    privacy: {
      sec1Title: '1. Ievads',
      sec1Text: 'Šī Privātuma politika skaidro, kā šīs vietnes administrators un datu pārzinis Mag.iur. Kaspars Linters, Reģ.Nr. 21048110122, apstrādā un aizsargā fizisko personu datus atbilstoši Eiropas Savienības Vispārīgajai datu aizsardzības regulai (VDAR 2016/679) un Latvijas Republikas Fizisko personu datu apstrādes likumam.',
      contactInfo: 'Kontaktinformācija:',
      phoneLabel: 'Tālrunis: 26841758',
      emailLabel: 'e-pasts: info@justiopro.lv',
      sec2Title: '2. Juridiskais pamats',
      sec2Text: 'Personas datu apstrādātājs – Latvijas Republikas Uzņēmumu reģistra Komercreģistrā reģistrētas juridiskas personas, kas Sabiedrības uzdevumā iegūst un apstrādā Klienta datus, lai nodrošinātu Pakalpojumu sniegšanu Sabiedrības vārdā. Personas datu apstrādātājs veic datu apstrādi ievērojot Sabiedrības norādījumus un izmantojot tehniskus un organizatoriskus pasākumus apstrādā Klientu datus tādā apmērā un kārtībā, kā to prasa un atļauj Latvijas Republikas un Eiropas Savienības normatīvie akti. Sīkāku informāciju par Personas datu apstrādātājiem var saņemt vēršoties pie Sabiedrības ar rakstveida pieprasījumu.',
      sec3Title: '3. Kādus personas datus mēs vācam',
      sec3Intro: 'Mēs varam apkopot un apstrādāt šādu informāciju par šīs vietnes apmeklētājiem:',
      sec3ContactLabel: 'kontaktinformācija:',
      sec3ContactText: 'vārds, uzņēmuma nosaukums, e-pasta adrese, tālruņa numurs',
      sec3TechLabel: 'Tehniskā informācija:',
      sec3TechText: 'IP adrese, pārlūkprogrammas veids, ierīces informācija, apmeklējuma laiks un datums',
      sec3UsageLabel: 'Lietošanas dati:',
      sec3UsageText: 'informācija par to, kā šīs vietnes apmeklētājs izmantojat mūsu mājas lapu un pakalpojumus',
      sec3CommLabel: 'Saziņas dati:',
      sec3CommText: 'Jūsu ziņojumu un komunikācijas saturs ar šīs vietnes pakalpojumu sniedzēju.',
      sec4Title: '4. Kā mēs izmantojam Jūsu datus',
      sec4Intro: 'Mēs izmantojam Jūsu personas datus šādiem mērķiem:',
      sec4Item1: 'Lai sniegtu Jums pieprasītos pakalpojumus un atbildētu uz Jūsu pieprasījumiem',
      sec4Item2: 'Lai sazinātos ar Jums par mūsu pakalpojumiem un piedāvājumiem',
      sec4Item3: 'Lai uzlabotu mūsu mājas lapu un pakalpojumu kvalitāti',
      sec4Item4: 'Lai izpildītu juridiskās saistības un aizsargātu savas likumīgās intereses',
      sec5Title: '5. Kādam mērķim mēs apstrādājam Jūsu datus',
      sec5Intro: 'Mēs apstrādājam Jūsu personas datus, pamatojoties uz:',
      sec5Item1Title: 'Jūsu piekrišanu',
      sec5Item1Text: 'kad Jūs aizpildāt mūsu kontaktformu un piekrītat datu apstrādes noteikumiem',
      sec5Item2Title: 'Līguma izpildi',
      sec5Item2Text: 'lai sniegtu Jums pieprasītos pakalpojumus',
      sec5Item3Title: 'Likumīgas intereses',
      sec5Item3Text: 'lai uzlabotu mūsu pakalpojumus un aizsargātu uzņēmumu',
      sec6Title: '6. Jūsu tiesības',
      sec6Intro: 'Saskaņā ar GDPR Jums ir šādas tiesības attiecībā uz Saviem personas datiem:',
      sec6Item1Title: 'Piekļuves tiesības',
      sec6Item1Text: 'pieprasīt piekļuvi Saviem personas datiem',
      sec6Item2Title: 'Labošanas tiesības',
      sec6Item2Text: 'labot neprecīzus vai nepilnīgus datus',
      sec6Item3Title: 'Dzēšanas tiesības',
      sec6Item3Text: 'pieprasīt Savu datu dzēšanu ("tiesības tikt aizmirstam")',
      sec6Item4Title: 'Ierobežošanas tiesības',
      sec6Item4Text: 'ierobežot Savu datu apstrādi',
      sec6Item5Title: 'Pārnesamības tiesības',
      sec6Item5Text: 'saņemt Savus datus strukturētā formātā',
      sec6Item6Title: 'Iebildumu tiesības',
      sec6Item6Text: 'iebilst pret Savu datu apstrādi',
      sec6Item7Title: 'Atsaukt piekrišanu',
      sec6Item7Text: 'jebkurā laikā atsaukt Savu piekrišanu datu apstrādei',
      sec6Outro: 'Lai izmantotu Savas tiesības, lūdzu, sazinieties ar mums, izmantojot kontaktinformāciju, kas norādīta šīs politikas sākumā.',
      sec7Title: '7. Sīkdatnes (Cookies)',
      sec7Text1: 'Mūsu mājas lapa izmanto sīkdatnes, lai uzlabotu Jūsu lietošanas pieredzi un analizētu mājas lapas apmeklējumu. Sīkdatnes ir mazi teksta faili, kas tiek saglabāti Jūsu ierīcē.',
      sec7Text2: 'Mēs izmantojam nepieciešamās sīkdatnes (nodrošina pamata funkcionalitāti) un analītikas sīkdatnes (palīdz saprast, kā apmeklētāji izmanto lapu). Jūs varat pārvaldīt sīkdatnes Savā pārlūkprogrammā.',
      sec8Title: '8. Trešo pušu pakalpojumi',
      sec8Text: 'Mēs varam izmantot uzticamus trešo pušu pakalpojumu sniedzējus, piemēram, mājas lapas mitināšanas pakalpojumus, e-pasta sūtīšanas pakalpojumus un analītikas rīkus (Google Analytics). Šie sniedzēji piekļūst datiem tikai tiktāl, cik tas nepieciešams to uzdevumu veikšanai.',
      sec9Title: '9. Izmaiņas privātuma politikā',
      sec9Text: 'Mēs paturam tiesības jebkurā laikā atjaunināt šo privātuma politiku. Izmaiņas stāsies spēkā, tiklīdz atjauninātā politika tiks publicēta mūsu mājas lapā.',
      sec10Title: '10. Sūdzības',
      sec10Text: 'Ja Jums ir sūdzības, lūdzu, vispirms sazinieties ar mums. Jums ir tiesības iesniegt sūdzību arī Datu valsts inspekcijā.',
    },
    cookies: {
