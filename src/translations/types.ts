...
export interface TranslationSchema {
  ...
  policyModal: {
    ...
    privacy: {
      ...
      sec5Title: string;
      sec5Intro: string;
      sec5Item1Title: string;
      sec5Item1Text: string;
      sec5Item2Title: string;
      sec5Item2Text: string;
      sec5Item3Title: string;
      sec5Item3Text: string;
      sec6Title: string;
      sec6Intro: string;
      sec6Item1Title: string;
      sec6Item1Text: string;
      sec6Item2Title: string;
      sec6Item2Text: string;
      sec6Item3Title: string;
      sec6Item3Text: string;
      sec6Item4Title: string;
      sec6Item4Text: string;
      sec6Item5Title: string;
      sec6Item5Text: string;
      sec6Item6Title: string;
      sec6Item6Text: string;
      sec6Item7Title: string;
      sec6Item7Text: string;
      sec6Outro: string;
      sec7Title: string;
      sec7Text1: string;
      sec7Text2: string;
