...
import { FAQS, IMAGES, COMPANY_INFO } from '../data/content';
...
export default function FaqPage() {
  ...
  return (
    <div id="faq-page" className="min-h-screen bg-[#CDD4DC] text-slate-900">
      <SEOHead
        title="BUJ – Biežāk Uzdotie Jautājumi"
        description="Atbildes uz biežāk uzdotajiem jautājumiem par JustioPro juridisko pakalpojumu izmaksām, konfidencialitāti, sadarbības procesu un konsultācijām."
      />
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-[#0B1F33] to-[#06121E] pt-20 sm:pt-24 pb-16 sm:pb-20 text-white border-b border-black">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center md:text-left">
          ...
          <h1 className="mt-4 text-4xl sm:text-5xl font-light tracking-tight text-white leading-tight">
            Biežāk <span className="font-semibold text-[#C9A45C]">uzdotie jautājumi</span>
          </h1>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 space-y-3.5">
          {FAQS.map((faq, index) => {
            ...
            return (
              ...
              >
                ...
                {isOpen && (
                  <div className="mt-3.5 pt-3.5 border-t border-slate-200/80 text-xs sm:text-sm font-light text-slate-700 leading-relaxed animate-in fade-in duration-200">
                    {faq.answer}
                  </div>
                )}
              </div>
          ...
          <div className="mt-10 rounded-2xl border border-black/70 bg-[#DFE3E8] p-7 sm:p-8 text-center space-y-3.5 shadow-xs">
            ...
            <p className="text-xs sm:text-sm font-light text-slate-700 max-w-lg mx-auto leading-relaxed">
              Sazinieties ar mums, un mēs labprāt atbildēsim uz visiem Jūsu jautājumiem par Jums nepieciešamo juridisko palīdzību.
            </p>
            <div className="pt-2 flex flex-wrap justify-center gap-3">
              ...
              >
                ...
                <span>Uzdodiet savu jautājumu</span>
              </Link>
            </div>
          </div>
